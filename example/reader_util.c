...
/*
  ...
  /* FTP 
   if ((is_ndpi_proto(flow, NDPI_PROTOCOL_FTP_CONTROL)) )
  {
 ...
 /*
  ...
  /* TLS */
   if ((is_ndpi_proto(flow, NDPI_PROTOCOL_TLS)) || (flow->detected_protocol.master_protocol == NDPI_PROTOCOL_TLS) || (flow->ndpi_flow->protos.stun_ssl.ssl.ja3_client[0] != '\0'))
  {
