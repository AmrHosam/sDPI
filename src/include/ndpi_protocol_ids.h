...
/*k (Nest Protect) - Darryl Sokoloski <darryl@egloo.ca> */
  ...
  NDPI_PROTOCOL_WHATSAPP_CALL         = 2, /* WhatsApp video ad audio calls go here */
  NDPI_PROTOCOL_TLS                   = 3,
  NDPI_PROTOCOL_FACEBOOK              = 4,
  NDPI_PROTOCOL_WHATSAPP              = 5,
 NDPI_PROTOCOL_WHATSAPP_FILES        = 6, /* Videos, pictures, voice messages... */
  NDPI_PROTOCOL_GITHUB                = 7,
    NDPI_PROTOCOL_GIT                   = 8,
